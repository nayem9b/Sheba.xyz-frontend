        ...
        <div className="container flex flex-col items-center px-4 py-12 mx-auto xl:flex-row">
          ...
          <div className="flex flex-col items-center mt-6 xl:items-start xl:w-1/2 xl:mt-0">
            ...
            <div className="mt-6 sm:-mx-2">
              <a
                href="#"
                className="inline-flex items-center justify-center w-full px-4 text-sm py-2.5 mt-4 overflow-hidden text-white transition-colors duration-300 bg-blue-600 rounded-lg shadow sm:w-auto sm:mx-2 sm:mt-0 hover:bg-blue-500 focus:ring focus:ring-blue-300 focus:ring-opacity-80 no-underline"
              >
                <svg
              ...
              <a
                href="#"
                className="inline-flex items-center justify-center w-full px-4 text-sm py-2.5 overflow-hidden text-white transition-colors duration-300 bg-gray-900 rounded-lg shadow sm:w-auto sm:mx-2 hover:bg-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700 focus:ring focus:ring-gray-300 focus:ring-opacity-80 no-underline"
              >
                <svg
                  className="w-5 h-5 mx-2 fill-current"
                  x="0px"
